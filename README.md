...
registrar recursos corporativos (equipamentos)
...
2️⃣ Recursos só podem ser alocados se estiverem disponíveis
...
3️⃣ Recursos de alto valor precisam de autorização
...
Esse projeto se inspirou em práticas comuns utilizadas em organizações.
...
1️⃣ onboarding (entrada na empresa)
2️⃣ movimentações internas
3️⃣ promoções
4️⃣ desligamento
...
1️⃣ Abrir o projeto no IntelliJ IDEA

2️⃣ Compilar o projeto

3️⃣ Executar a classe:
